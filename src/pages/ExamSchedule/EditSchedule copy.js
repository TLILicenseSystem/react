...
const EditSchedule = () => {
  ...
  const [examDate, setExamDate] = useState(
    moment(get(scheduleDetail.selected, "examDate", "")),
    "DD/MM/yyyy"
  );
  const [closeDate, setCloseDate] = useState(
    moment(get(scheduleDetail.selected, "applyCloseDate", "")),
    "DD/MM/yyyy"
  );
          ...
          <Card>
            <CardBody>
              ...
              <BoxScheduleFirst
                ...
                onClickInRoundTime={(e) =>
                  setExamTime(e.roundId, setERoundTime(false))
                }
